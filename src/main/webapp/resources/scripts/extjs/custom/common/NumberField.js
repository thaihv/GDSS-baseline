Ext.define('Ext.custom.common.NumberField', {
    ...
    setValue: function(value){
        Ext.custom.common.NumberField.superclass.setValue.call(this, value != null ? value.toString().replace('.', this.decimalSeparator) : value);
    ...
    parseValue: function(value){
        ...
        return Ext.custom.common.NumberField.superclass.parseValue.call(this, this.removeFormat(value));
    },
    /**
    ...
    getErrors: function(value){
        return Ext.custom.common.NumberField.superclass.getErrors.call(this, this.removeFormat(value));
    },
    hasFormat: function(){
