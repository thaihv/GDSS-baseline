...
$Id: proj4js.js,v 1.2 2010/06/09 00:43:05 °ûÈ¿¼® Exp $
*/
...
Proj4js = {
    ...
    */
    transform: function(source, dest, point) {
     	//alert(source.readyToUse + ":" + dest.readyToUse);    	
...
Proj4js.Proj = Proj4js.Class({
  ...
  */
  initialize: function(srsCode) {
      ...
      } else if (this.srsCode.indexOf("LP") == 0) {
          this.srsCode = this.srsCode;
          this.srsAuth = 'lp';
          this.srsProjNumber = this.srsCode.substring(3);    
...
Proj4js.defs = {
  ...
  'EPSG:2097': "+title=long/lat:KOR_GRS80 +proj=tmerc +lat_0=38 +lon_0=127 +k=1 +x_0=200000 +y_0=500000 +ellps=bessel +units=m +no_defs",  
  'LP:8880': "+title=long/lat:KOR_GRS80 +proj=tmerc +lat_0=38 +lon_0=127 +k=1 +x_0=200000 +y_0=500000 +ellps=WGS84 +units=m +no_defs"
};
