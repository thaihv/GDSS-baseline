 ...
 * (end)
 */
OpenLayers.PopupCustom = OpenLayers.Class({
    ...
    */
    initialize:function(id, lonlat, contentSize, contentHTML, closeBox, closeBoxCallback) {
        ...
        this.backgroundColor = null;//OpenLayers.Popup.COLOR;
        this.opacity = OpenLayers.Popup.OPACITY;
        this.border = null//OpenLayers.Popup.BORDER;
    ...
    */
    ...
    setBorder:function(border) { 
        ...
        if (this.div != null) {
            this.div.style.border = "0";//this.border;
        }
    },      
    ...
    addCloseBox: function(callback) {
        ...
        this.closeDiv = OpenLayers.Util.createDiv(
            this.id + "_close", null, new OpenLayers.Size(12, 12)
        );
    ...
    CLASS_NAME: "OpenLayers.PopupCustom"
});
